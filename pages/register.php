            ...
            <form method="POST" action="">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="<?= e($_POST['email'] ?? '') ?>" required
                           class="input-field" placeholder="student@campus.edu">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="department" value="<?= e($_POST['department'] ?? '') ?>"
                           class="input-field" placeholder="Computer Science">
                </div>

                <div class="mb-6">
                    <label class="label">College ID (Optional)</label>
                    <input type="text" name="college_id" value="<?= e($_POST['college_id'] ?? '') ?>"
                           class="input-field" placeholder="2024CS12345">
                </div>

                <button type="submit" class="btn-primary mb-4">Create Student Account</button>

                <p style="font-family:'Space Mono',monospace; font-size:0.75rem; color:#666; text-align:center;">
                    Already have an account? <a href="login.php" style="color:var(--black); font-weight:700; text-decoration:underline;">Login here</a>
                </p>
            </form>
